...
public class CVResponse implements Serializable {
    ...
    public CVResponse(int id, String nom, String prenom, int age, String addresse, String email, String telephone, String specialite, String niveauEtude, String experienceProfessionnelle) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
        this.age = age;
